...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Nara tarjetaNara = new Nara("1784-9334-1649-0004", "Analia Bolaños", LocalDate.of(23, 12, 1), "Naranja", 500);
		Amex tarjetaAmex = new Amex("8224-9031-0098-2304", "Franco Bolaños", LocalDate.of(27, 9, 1), "Amex", 1100);
